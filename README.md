...
Ongoing maintenance and development of this project is in the [Session Technology Foundation
fork](https://github.com/session-foundation/session-pysogs).  For more details, see announcements
...
foundation dedicated to advancing digital rights and innovation.
